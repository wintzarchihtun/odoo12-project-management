...
#     _name='project.team'
#     _description='for create a team'
#
...
class Task(models.Model):
    ...
    tag_ids = fields.Many2many('project.tags', string='Tags', oldname='categ_ids',readonly=True)
    ...
    date_deadline = fields.Date(string='Deadline', index=True, copy=False, track_visibility='onchange', readonly=True)
    ...
    planned_hours = fields.Float("Planned Hours",help='It is the time planned to achieve the task. If this document has sub-tasks, it means the time needed to achieve this tasks and its childs.',track_visibility='onchange',readonly=True )
    ...
    user_id = fields.Many2one('res.users',
        ...
        index=True, track_visibility='always',readonly=False)
